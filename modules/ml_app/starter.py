...
pos_formations = {
    "ST": ("4-4-2", "4-1-4-1", "4-1-2-3", "3-5-2", "4-3-1-2", "4-3-3"),
    "LW": ("4-1-2-3", "4-3-3"),
    "RW": ("4-1-2-3", "4-3-3"),
    "CAM": ("4-1-2-3", "4-3-1-2"),
    "CM": ("4-4-2", "4-1-4-1", "3-5-2", "4-3-3"),
    "LM": ("4-4-2", "4-1-4-1", "3-5-2", "4-3-3"),
    "RM": ("4-4-2", "4-1-4-1", "3-5-2", "4-3-3"),
    "CDM": ("4-1-4-1", "4-1-2-3", "3-5-2", "4-3-1-2"),
    "CB": ("4-4-2", "4-1-4-1", "4-1-2-3", "3-5-2", "4-3-1-2", "4-3-3"),
    "LB": ("4-4-2", "4-1-4-1", "4-1-2-3", "4-3-1-2", "4-3-3"),
    "RB": ("4-4-2", "4-1-4-1", "4-1-2-3", "4-3-1-2", "4-3-3"),
    "GK": ("4-4-2", "4-1-4-1", "4-1-2-3", "3-5-2", "4-3-1-2", "4-3-3"),
}
...
class Starter:
    ...
    def save_to_path(self, df):
        ...
        if not os.path.exists(self.path):
            os.mkdir(self.path)
        df.to_csv(self.path + "/{}_records.csv".format(self.pos), index=False, encoding="utf-8-sig")
